...
public class PatientIdDoesNotExisteException extends UseCaseHealthException{

	private static final long serialVersionUID = 1L;

	public PatientIdDoesNotExisteException() {
		super(MessageCatalog.getContentMessage(MessageCode.M0000044));
	}
