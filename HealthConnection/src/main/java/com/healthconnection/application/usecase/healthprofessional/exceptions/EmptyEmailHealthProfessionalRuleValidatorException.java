...
public class EmptyEmailHealthProfessionalRuleValidatorException extends UseCaseHealthException{

	private static final long serialVersionUID = 1L;

	public EmptyEmailHealthProfessionalRuleValidatorException() {
