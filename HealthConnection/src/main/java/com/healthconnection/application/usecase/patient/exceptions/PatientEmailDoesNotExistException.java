...
@Service
public class PatientEmailDoesNotExistException extends DomainHealthException{

	private static final long serialVersionUID = 1L;

	public PatientEmailDoesNotExistException() {
		super(MessageCatalog.getContentMessage(MessageCode.M0000007));
	}
