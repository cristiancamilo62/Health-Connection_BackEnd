...
public class EmptyDateBirthHealthProfessionalRuleValidatorException extends UseCaseHealthException{

	private static final long serialVersionUID = 1L;

	public EmptyDateBirthHealthProfessionalRuleValidatorException() {
